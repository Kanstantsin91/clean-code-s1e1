...
var taskInput=document.querySelector(".add-form__task");//Add a new task.
var addButton=document.querySelector(".button_add")//first button
var incompleteTaskHolder=document.querySelector(".task-list");//ul of #incomplete-tasks
...
var editTask=function(){
    ...
    var containsClass=listItem.classList.contains("task-list__item_edited");
    ...
    listItem.classList.toggle("task-list__item_edited");
};
